...
export function LeadCaptureModal({ children, plan = 'skip-basic-home' }: LeadCaptureModalProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (plan === 'skip-gold-home') {
        ...
        window.location.href = `https://go.adapta.org/checkout/${plan}?${params.toString()}`
      }
    }
  }
